    ...
    public partial class Baseline : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    delivery_type_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_delivery_type", x => x.delivery_type_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    energy_kj = table.Column<int>(type: "integer", nullable: true),
                    energy_kcal = table.Column<int>(type: "integer", nullable: true),
                    fat_g = table.Column<decimal>(type: "numeric", nullable: true),
                    sat_fat_g = table.Column<decimal>(type: "numeric", nullable: true),
                    carbs_g = table.Column<decimal>(type: "numeric", nullable: true),
                    sugar_g = table.Column<decimal>(type: "numeric", nullable: true),
                    protein_g = table.Column<decimal>(type: "numeric", nullable: true),
                    salt_g = table.Column<decimal>(type: "numeric", nullable: true),
                    unit_type = table.Column<string>(type: "text", nullable: false),
                    unit_size = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_delivery_type_delivery_type_id",
